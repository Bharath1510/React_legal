...
import * as strings from 'LegalDashboardWebPartStrings';
import LegalDashboard from './components/LegalDashboard';
import { ILegalDashboardProps } from './components/ILegalDashboardProps';

export interface ILegalDashboardWebPartProps {
  description: string;
}
